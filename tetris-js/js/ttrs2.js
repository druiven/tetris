...
/*function fillBlocksArray(){*/
    for (var i = 0; i < tB.length; i++) {
        for (var j = 0; j < 4; j++) {
            globalBlocks[(i * 4) + j] = i;

        }
    }
/*}*/
//fillBlocksArray();
playingBlocks=globalBlocks.slice();
...
//-----------------------------------------
var pieces = [];
/* GD uses global playingBlocks: Array of tB indexes*/
function randomPiece() {
    if (playingBlocks.length <1)
        playingBlocks=globalBlocks.slice();//fillBlocksArray();
    var num = playingBlocks.splice(random(0, playingBlocks.length - 1), 1)[0];
